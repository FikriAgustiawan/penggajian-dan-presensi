...
<div class="row" style="margin-top:70px">
    <div class="col">
        <form method="POST" action="/izincuti/store" id="frmIzin">
            ...
            <div class="form-group">
                <input type="hidden" id="max_cuti" name="max_cuti" class="form-control" autocomplete="off" placeholder="Maksimal Cuti" readonly>
...
@push('myscript')
    <script>
        ...
        function loadjumlahhari() {
            ...
            $("#info_jml_hari").html(
                "<b>Jumlah Hari Cuti Yang Di Ambil : " + jmlhari + " Hari</b>");
        }
        ...
        $("#frmIzin").submit(function(){
            ...
            if (tgl_izin_dari == "" || tgl_izin_sampai == ""){
                ...
                Swal.fire({
                            title: 'Oops !',
                            text: 'Ketegori Cuti Harus Diisi',
                            icon: 'warning',
                        });
                return false;
            }
        ...
        $("#kode_cuti").change(function(e) {
            ...
            if(tgl_izin_dari=="")
            {
                ...
                success:function(respond){
                    ...
                    $("#info_max_cuti").html(
                        "<b>Maksimal Cuti Yang Bisa Di Ambil Adalah : " + respond + " Hari</b>");
                }
            });
            } 
        });
