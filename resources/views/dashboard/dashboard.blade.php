    ...
    <div id="rekappresensi">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:5px; z-index:999">{{ $rekappresensi->jmlizin }}
                        </span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:5px; z-index:999">{{ $rekappresensi->jmlsakit }}
                        </span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:5px; z-index:999">{{ $rekappresensi->jmlcuti }}
                        </span>
                        <ion-icon name="calendar-outline" style="font-size: 1.6rem;" class="text-primary mb-1"></ion-icon>
                        <br>
