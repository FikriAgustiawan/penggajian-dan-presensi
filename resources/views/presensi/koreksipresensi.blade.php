    ...
    <div class="row" id="frm_jam_in">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="jam_in" value="{{ $presensi != null ? $presensi->jam_in : '' }}" class="form-control" name="jam_in" placeholder="Jam Masuk">
              </div>
        </div>
    </div>
    <div class="row" id="frm_jam_out">
        <div class="col-12">
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                ...
                <input type="text" id="jam_out" value="{{ $presensi != null ? $presensi->jam_out : '' }}" class="form-control" name="jam_out" placeholder="Jam Pulang">
              </div>
        </div>
    </div>
    <div class="row mb-3" id="frm_kode_jam_kerja">
        <div class="col-12">
            <div class="form-group">
