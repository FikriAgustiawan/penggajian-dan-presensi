...
<div class="modal modal-blur fade" id="modal-inputuser" tabindex="-1" aria-hidden="true" style="display: none;">
...
{{-- Modul Edit --}}
<div class="modal modal-blur fade" id="modal-edituser" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
