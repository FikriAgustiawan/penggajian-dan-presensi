...
class IzincutiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($jmlhari > $sisacuti){
            return redirect('/presensi/izin')->with(['error'=>'Jumlah Hari Melebihi Batas Maksimal Jatah Cuti Tahunan, Sisa Cuti Anda Adalah ' .$sisacuti. ' Hari']);
            ...
            return redirect('/presensi/izin')->with(['error'=>'Tidak Bisa Melakukan Pengajuan Pada Tanggal ' .$blacklistdate. 'Karena Ada Tanggal Yang Sudah Digunakan Sebelumnya']);
        } else {
